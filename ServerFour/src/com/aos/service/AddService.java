...
public class AddService implements ServletContextListener{
	...
	public int add(int i, int j) {
		System.out.println("Add Service on server4 called");
		return i+j;
	}
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		params.setServiceName("add3");
		params2.setServiceName("add3");
		...
		System.out.println("WSDL for add service on server4 deleted from Service registry on stopping service or failure of service");
	}
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			//Sending own WSDL
			String wsdl = "http://"+ip.getHostAddress()+":8083/ServerFour/services/AddService?wsdl";
			params.setWSDL(wsdl);
		...
		System.out.println("WSDL is sent from add service on server4 to service registry");
