...
public class ModService implements ServletContextListener{
	...
	public int mod(int i, int j) {
		System.out.println("Mod Service on server4 called");
		return i%j;
	}
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		params.setServiceName("mod3");
		params2.setServiceName("mod3");
		...
		System.out.println("WSDL for mod service on server4 deleted from Service registry on stopping service or failure of service");
	}
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			//Sending own WSDL
			String wsdl = "http://"+ip.getHostAddress()+":8083/ServerFour/services/ModService?wsdl";
			params.setWSDL(wsdl);
		...
		System.out.println("WSDL is sent from mod service on server4 to service registry");
