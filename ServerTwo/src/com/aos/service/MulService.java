...
public class MulService implements ServletContextListener{
	...
	public int mul(int i, int j) {
		System.out.println("Mul Service on server2 called");
		return i*j;
	}
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		params.setServiceName("mul2");
		params2.setServiceName("mul2");
		...
		System.out.println("WSDL for mul service on server2 deleted from Service registry on stopping service or failure of service");
	}
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			//Sending own WSDL
			String wsdl = "http://"+ip.getHostAddress()+":8081/ServerTwo/services/MulService?wsdl";
			params.setWSDL(wsdl);
		...
		System.out.println("WSDL is sent from mul service on server2 to service registry");
