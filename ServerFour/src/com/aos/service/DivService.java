...
public class DivService implements ServletContextListener{
	...
	public int add(int i, int j) {
		System.out.println("Div Service on server4 called");
		return i/j;
	}
	...
	public void contextDestroyed(ServletContextEvent sce) {
		...
		params.setServiceName("div3");
		params2.setServiceName("div3");
		...
		System.out.println("WSDL for div service on server4 deleted from Service registry on stopping service or failure of service");
	}
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			//Sending own WSDL
			String wsdl = "http://"+ip.getHostAddress()+":8083/ServerFour/services/DivService?wsdl";
			params.setWSDL(wsdl);
		...
		System.out.println("WSDL is sent from div service on server4 to service registry");
	}
}
